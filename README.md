...
```
az vm image list --all --publisher neo4j --offer neo4j-enterprise-4-3 --query '[].urn'
```

Then grab that URN and accept terms of it:

```
$ az vm image accept-terms --urn neo4j:neo4j-enterprise-4-3:neo4j_enterprise_4_3_6:1.1.3"
{
  "accepted": true,
  "id": "/subscriptions/e4486a99-00d6-4e46-aab0-b087f918eda9/providers/Microsoft.MarketplaceOrdering/offerTypes/Microsoft.MarketplaceOrdering/offertypes/publishers/neo4j/offers/neo4j-enterprise-4-3/plans/neo4j_4_3_6_apoc/agreements/current",
  ...
  "name": "neo4j_4_3_6_apoc",
  "plan": "neo4j_4_3_6_apoc",
  "privacyPolicyLink": "https://neo4j.com/privacy-policy/",
  "product": "neo4j-enterprise-4-3",
  "publisher": "neo4j",
...
```
			"imageReference": {
                "publisher": "neo4j",
                "offer": "neo4j-enterprise-4-3",
                "sku": "neo4j_enterprise_4_3_6",
                "version": "latest"
			},
```
