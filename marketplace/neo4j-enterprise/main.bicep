...
var cloudInitStep3 = replace(cloudInitStep2, '\${admin_password}', passwordPlaceholder)
...
var rrStep1 = replace(cloudInitReadReplica, '\${admin_password}', passwordPlaceholder)
